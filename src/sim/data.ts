...
/** Dominance generated by each completed operational Spinal pair. */
export const DOMINANCE_PER_ALIGNED_PAIR_PER_SEC = 2;
export const SPINAL_CAPTURE_RADIUS = 110;
export const SPINAL_CAPTURE_QUERY_RADIUS = 130;
export const SPINAL_CAPTURE_RATE_PER_UNIT = 0.05;
export const SPINAL_CAPTURE_STRENGTH_CAP = 3;
export const SPINAL_CAPTURE_ENDPOINT_EPSILON = 1e-9;
