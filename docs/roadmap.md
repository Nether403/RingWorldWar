...
| LS-15 integrated public-alpha tutorial arc | Active, automation-passed | Bounded contract, dedicated integrated-arc browser lane at 1280x720 Low, tutorial/campaign unit lane, full check, and protected core match passed; the G-02 four-of-five uncoached novice cohort remains the completion requirement |
