...
| LS-11 Gravity Range | Active | Explicit launch mode; current directional-artillery scenario remains validation tooling rather than the shipped mode |
