...
- [ ] Isolate JIT, GC, and shared-machine contention on a clean pinned runner.
...
- [ ] Qualify Requirement 17.5 on pinned hardware.
...
- [ ] Register `t480s-headless-01`, restrict its runner group, configure the protected `headless-qualification` Environment, then capture the first clean receipt.
